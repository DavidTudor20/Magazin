...
int main(int argc, char* argv[]) {
    ...
    // COMANDA INVALIDA SAU LIPSESC ARGUMENTE
        ...
        std::cerr << "  ./app_1.exe vizualizare_produse_de_pe_stoc\n";
        std::cerr << "  ./app_1.exe adaugare_produs <cod> <nume> <cantitate> <pret>\n";
        std::cerr << "  ./app_1.exe stergere_produs <cod>\n";
        std::cerr << "  ./app_1.exe modificare_produs <pret|cantitate> <cod> <valoare>\n";
        std::cerr << "  ./app_1.exe vizualizare_comenzi\n";
        return 1;
    }
